...
#define SNJ_CONFIG_COMPACT_AUTO UINT32_MAX
#define SNJ_DEFAULT_TOOL_OUTPUT_TOKENS 6000u
...
bool snj_config_provider_is_openrouter(const struct snj_provider_config *provider);
