...
enum snag_rule_verb {
    SNAG_RULE_PASS, SNAG_RULE_ACCEPT, SNAG_RULE_REJECT, SNAG_RULE_JUMP,
    SNAG_RULE_RETURN, SNAG_RULE_INSERT, SNAG_RULE_COMMAND, SNAG_RULE_CONFIRM, SNAG_RULE_VERB_COUNT };
