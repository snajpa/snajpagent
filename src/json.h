...
json_t *snag_json_load_canonical_bounded(const unsigned char *data, size_t len, size_t max_len,
...
bool snag_json_arg_text(const json_t *, const char *, size_t, size_t, bool, const char **, char *, size_t);
