...
tests/test_base: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c tests/test_base.c src/base.h src/fs.h src/term_host.h src/wake.h src/net.h
	$(CC) $(CPPFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c tests/test_base.c

tests/test_config: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/config.c src/secret_source.c tests/test_config.c src/base.h src/fs.h src/term_host.h src/wake.h src/net.h src/config.h src/secret_source.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/config.c src/secret_source.c tests/test_config.c $(LDLIBS)

tests/test_irc: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/config.c src/secret_source.c src/irc.c src/irc_runtime.c tests/test_irc.c src/base.h src/fs.h src/term_host.h src/wake.h src/net.h src/config.h src/secret_source.h src/cli.h src/irc.h src/irc_internal.h src/snajpagent.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ \
		src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/config.c src/secret_source.c src/irc.c src/irc_runtime.c tests/test_irc.c $(LDLIBS)

tests/test_credential: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/credential.c src/secret_source.c tests/test_credential.c src/base.h src/fs.h src/term_host.h src/wake.h src/net.h src/credential.h src/secret_source.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/credential.c src/secret_source.c tests/test_credential.c $(LDLIBS)

tests/test_instructions: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/instructions.c tests/test_instructions.c src/base.h src/fs.h src/term_host.h src/wake.h src/net.h src/json.h src/instructions.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/instructions.c tests/test_instructions.c $(LDLIBS)

tests/test_sse: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/sse.c tests/test_sse.c src/base.h src/fs.h src/term_host.h src/wake.h src/net.h src/sse.h
	$(CC) $(CPPFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/sse.c tests/test_sse.c

tests/test_json: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c tests/test_json.c src/base.h src/fs.h src/term_host.h src/wake.h src/net.h src/json.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c tests/test_json.c $(LDLIBS)

tests/test_wire: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/wire.c tests/test_wire.c src/base.h src/fs.h src/term_host.h src/wake.h src/net.h src/json.h src/snag_jansson.h src/snag_jansson_abi.h src/wire.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/wire.c tests/test_wire.c $(LDLIBS)

tests/test_responses: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/sse.c src/responses.c src/turn.c \
	...
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/sse.c src/responses.c src/turn.c \
...
tests/test_turn: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/turn.c src/tools_read.c tests/test_turn.c $(HEADERS)
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/turn.c src/tools_read.c tests/test_turn.c $(LDLIBS)


tests/test_tools: src/base.c src/platform.c src/term_host.c src/wake.c src/net.c src/json.c src/wire.c src/credential.c src/secret.c src/config.c src/secret_source.c src/turn.c src/tools.c src/tools_read.c src/tools_patch.c tests/test_tools.c $(HEADERS)
