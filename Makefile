...
tests/test_base: src/base.c src/platform.c src/wake.c src/net.c tests/test_base.c src/base.h src/fs.h src/wake.h src/net.h
	$(CC) $(CPPFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ src/base.c src/platform.c src/wake.c src/net.c tests/test_base.c

tests/test_config: src/base.c src/platform.c src/wake.c src/net.c src/config.c src/secret_source.c tests/test_config.c src/base.h src/fs.h src/wake.h src/net.h src/config.h src/secret_source.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ src/base.c src/platform.c src/wake.c src/net.c src/config.c src/secret_source.c tests/test_config.c $(LDLIBS)

tests/test_irc: src/base.c src/platform.c src/wake.c src/net.c src/config.c src/secret_source.c src/irc.c src/irc_runtime.c tests/test_irc.c src/base.h src/fs.h src/wake.h src/net.h src/config.h src/secret_source.h src/cli.h src/irc.h src/irc_internal.h src/snajpagent.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ \
		src/base.c src/platform.c src/wake.c src/net.c src/config.c src/secret_source.c src/irc.c src/irc_runtime.c tests/test_irc.c $(LDLIBS)

tests/test_credential: src/base.c src/platform.c src/wake.c src/net.c src/credential.c src/secret_source.c tests/test_credential.c src/base.h src/fs.h src/wake.h src/net.h src/credential.h src/secret_source.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ src/base.c src/platform.c src/wake.c src/net.c src/credential.c src/secret_source.c tests/test_credential.c $(LDLIBS)

tests/test_instructions: src/base.c src/platform.c src/wake.c src/net.c src/json.c src/instructions.c tests/test_instructions.c src/base.h src/fs.h src/wake.h src/net.h src/json.h src/instructions.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/json.c src/instructions.c tests/test_instructions.c $(LDLIBS)

tests/test_sse: src/base.c src/platform.c src/wake.c src/net.c src/sse.c tests/test_sse.c src/base.h src/fs.h src/wake.h src/net.h src/sse.h
	$(CC) $(CPPFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc -o $@ src/base.c src/platform.c src/wake.c src/net.c src/sse.c tests/test_sse.c

tests/test_json: src/base.c src/platform.c src/wake.c src/net.c src/json.c tests/test_json.c src/base.h src/fs.h src/wake.h src/net.h src/json.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/json.c tests/test_json.c $(LDLIBS)

tests/test_wire: src/base.c src/platform.c src/wake.c src/net.c src/json.c src/wire.c tests/test_wire.c src/base.h src/fs.h src/wake.h src/net.h src/json.h src/snag_jansson.h src/snag_jansson_abi.h src/wire.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/json.c src/wire.c tests/test_wire.c $(LDLIBS)

tests/test_responses: src/base.c src/platform.c src/wake.c src/net.c src/json.c src/sse.c src/responses.c src/turn.c \
		tests/test_responses.c src/base.h src/fs.h src/wake.h src/net.h src/json.h src/sse.h src/responses.h src/turn.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/json.c src/sse.c src/responses.c src/turn.c \
...
tests/test_context: src/base.c src/platform.c src/wake.c src/net.c src/config.c src/secret_source.c src/json.c src/instructions.c src/context.c src/turn.c src/store.c src/store_lookup.c src/store_lifecycle.c tests/test_context.c $(HEADERS)
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/config.c src/secret_source.c src/json.c src/instructions.c src/context.c src/turn.c src/store.c src/store_lookup.c src/store_lifecycle.c \
		tests/test_context.c $(LDLIBS)

tests/test_model_cache: src/base.c src/platform.c src/wake.c src/net.c src/config.c src/secret_source.c src/json.c src/instructions.c src/turn.c src/store.c src/model_cache.c tests/test_model_cache.c $(HEADERS)
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/config.c src/secret_source.c src/json.c src/instructions.c src/turn.c src/store.c src/model_cache.c \
		tests/test_model_cache.c $(LDLIBS)

tests/test_render: src/base.c src/platform.c src/wake.c src/net.c src/json.c src/history.c src/term.c src/render.c src/render_prepare.c tests/test_render.c \
		src/base.h src/fs.h src/wake.h src/net.h src/json.h src/term.h src/term_host.h src/render.h src/snajpagent.h
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/json.c src/history.c src/term.c src/render.c src/render_prepare.c tests/test_render.c $(LDLIBS)

tests/test_turn: src/base.c src/platform.c src/wake.c src/net.c src/json.c src/turn.c src/tools_read.c tests/test_turn.c $(HEADERS)
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/json.c src/turn.c src/tools_read.c tests/test_turn.c $(LDLIBS)


tests/test_tools: src/base.c src/platform.c src/wake.c src/net.c src/json.c src/wire.c src/credential.c src/secret.c src/config.c src/secret_source.c src/turn.c src/tools.c src/tools_read.c src/tools_patch.c tests/test_tools.c $(HEADERS)
	$(CC) $(CPPFLAGS) $(JANSSON_CFLAGS) $(CFLAGS) -O0 $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/json.c src/wire.c src/credential.c src/secret.c \
		src/config.c src/secret_source.c src/turn.c src/tools.c src/tools_read.c src/tools_patch.c tests/test_tools.c $(LDLIBS)

tests/test_store: src/base.c src/platform.c src/wake.c src/net.c src/json.c src/instructions.c src/turn.c src/store.c src/store_lookup.c src/store_lifecycle.c tests/test_store.c $(HEADERS)
	$(CC) $(CPPFLAGS) -DSNAJPAGENT_TEST_FIXTURE=1 $(JANSSON_CFLAGS) $(CFLAGS) $(LDFLAGS) -Isrc \
		-o $@ src/base.c src/platform.c src/wake.c src/net.c src/json.c src/instructions.c src/turn.c src/store.c src/store_lookup.c src/store_lifecycle.c tests/test_store.c $(LDLIBS)
