...
AUDIO_DEVICE_LIBS ?= $(if $(filter Windows Windows_NT,$(TARGET_OS)),-lole32 -lwinmm,$(if $(filter Darwin,$(TARGET_OS)),-framework CoreFoundation -framework CoreAudio -framework AudioToolbox,$(if $(filter FreeBSD OpenBSD,$(TARGET_OS)),-lm,-ldl -lm)))
