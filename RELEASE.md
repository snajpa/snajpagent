...
On September 23, 2026, the operator removed Linux PPC32 from the supported
production matrix before the 0.99.8 release; no PPC32 executable shipped in
0.99.7. Its pinned recipe remains an **opt-in, unsupported local build** via
`make prod-linux-ppc32`, outside `prod-matrix`, release assets and update
channels. Historical emulated runtime checks remain documented; they do not
qualify a 0.99.8 release artifact.
